...
function getVersion() {
	try {
		if (typeof process !== "undefined" && process.env && process.env.npm_package_version) return process.env.npm_package_version;
...
var FirecrawlApp = class {
	...
	async getVersion() {
		try {
			...
			if (!(typeof process !== "undefined" && (process.env.JEST_WORKER_ID != null || false))) console.error("Error getting version:", error);
			return "1.25.1";
		}
	}
	async init() {
